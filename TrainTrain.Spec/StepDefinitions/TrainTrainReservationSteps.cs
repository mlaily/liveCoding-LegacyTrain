...
namespace TrainTrain.Spec.StepDefinitions
{
    ...
    public class TrainTrainReservationSteps
    {
        ...
        [Given(@"the train ""(.*)"" with (.*) coaches of (.*) seats available")]
        public void GivenTheTrainContainsCoachesOfSeatsAvailables(string trainId, int coachCount, int seatsCount)
        {
            _trainId = trainId;
        ...
        [Given(@"the train ""(.*)"" with (.*) coaches of (.*) seats and (.*) already reserved")]
        public void GivenTheTrainContainsCoachesOfSeatsWithAlreadyReserved(string trainId, int coachesCount, int availableSeatsCount,
        ...
        [Given(@"the train ""(.*)"" with (.*) coaches of (.*) seats and (.*) seats already reserved in the coach (.*)")]
        public void GivenTheTrainContainsCoachesOfSeatsWithSeatsAlreadyReservedInTheCoach(string trainId, int coachesCount,
            int availableSeatsCount, int seatsReservedCount, int coachNumberWhereReserved)
        {
            _trainId = trainId;
            _trainTopology =

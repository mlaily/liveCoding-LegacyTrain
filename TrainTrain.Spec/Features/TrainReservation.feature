...
Scenario: For a train overall, no more than 70% of seats may be reserved in advance
	Given the train "9043-2018-04-17" with 1 coaches of 10 seats available
...
Scenario: Not reserve seats when it exceeds train max capacity 70%
	Given the train "9043-2018-04-17" with 1 coaches of 10 seats and 6 already reserved
	When 3 seats are requested
...
Scenario: Each reservation must be booked in the same coach
	Given the train "9043-2018-04-17" with 2 coaches of 10 seats and 9 seats already reserved in the coach 1

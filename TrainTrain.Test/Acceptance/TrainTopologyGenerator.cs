namespace TrainTrain.Test.Acceptance
{
    public class TrainTopologyGenerator
    {
        ...
        public static string GetTrainWith3CoachesAnd5SeatsAlreadyReservedInTheFirstCoach()
        {
            return "{\"seats\": {" +
        ...
        public static string GetTrainWith3CoachesAnd6SeatsThen4Then4AlreadyReserved()
        {
            return "{\"seats\": {" +

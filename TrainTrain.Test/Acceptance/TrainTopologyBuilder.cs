namespace TrainTrain.Test.Acceptance
{
    ...
    {
        public static string GetTrainWith1CoachAnd10AvailableSeats()
        {
            var trainTopology =
                "{\"seats\": {" +
        ...
        public static string GetTrainWith1CoachAnd4AvailableSeats()
        {
            return "{\"seats\": {" +
        ...
        public static string GetTrainWith2CoachesWith9SeatsAlreadyReservedInTheFirstCoach()
        {
            return "{\"seats\": {" +
